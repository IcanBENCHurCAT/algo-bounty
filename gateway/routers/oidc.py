from ..schemas import OIDCVerifyResponse
...
@router.post("/verify", response_model=OIDCVerifyResponse, summary="Verify GitHub OIDC token", description="Validate a GitHub Actions OIDC token to confirm the identity of a running workflow. Used for automated bounty claiming and submission.")
